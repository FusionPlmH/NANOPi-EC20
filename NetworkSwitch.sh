...
cndns_wired=$(ping -I eth0 -c 3 114.114.114.114 | grep 'received' | awk '{print $4}' | cut -d '/' -f 1)
...
cndns_modem=$(ping -I eth0 -c 3 114.114.114.114 | grep 'received' | awk '{print $4}' | cut -d '/' -f 1)
